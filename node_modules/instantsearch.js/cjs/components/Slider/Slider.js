...
function (_Component) {
  ...
  function Slider() {
    ...
    _defineProperty(_assertThisInitialized(_this), "createHandleComponent", function (tooltips) {
      return function (props) {
        ...
        var value = (0, _has.default)(tooltips, 'format') ? tooltips.format(roundedValue) : roundedValue;
  ...
  _createClass(Slider, [{
    ...
    value: function computeDefaultPitPoints(_ref2) {
      ...
      var pitPoints = [min].concat(_toConsumableArray((0, _times.default)(steps - 1, function (step) {
    ...
    value: function computeSnapPoints(_ref3) {
      ...
      return [].concat(_toConsumableArray((0, _range.default)(min, max, step)), [max]);
    }
  }, {
    key: "render",
