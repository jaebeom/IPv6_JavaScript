    ...
    return {
      ...
      getConfiguration: function getConfiguration(currentConfiguration) {
        if (currentConfiguration.hierarchicalFacets) {
          var isFacetSet = (0, _find.default)(currentConfiguration.hierarchicalFacets, function (_ref) {
            var name = _ref.name;
            return name === hierarchicalFacetName;
          });

          if (isFacetSet && !((0, _isEqual.default)(isFacetSet.attributes, attributes) && isFacetSet.separator === separator)) {
            (0, _utils.warning)((0, _isEqual.default)(isFacetSet.attributes, attributes) && isFacetSet.separator === separator, 'Using Breadcrumb and HierarchicalMenu on the same facet with different options overrides the configuration of the HierarchicalMenu.');
            return {};
          }
        }
      ...
      getWidgetState: function getWidgetState(uiState, _ref5) {
        ...
        if (uiState.hierarchicalMenu && (0, _isEqual.default)(path, uiState.hierarchicalMenu[hierarchicalFacetName])) {
          return uiState;
        }
