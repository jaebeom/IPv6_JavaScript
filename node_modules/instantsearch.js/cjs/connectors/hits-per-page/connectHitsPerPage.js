...
function connectHitsPerPage(renderFn, unmountFn) {
  ...
  return function () {
    ...
    var defaultValue = (0, _find.default)(userItems, function (item) {
    ...
    return {
      ...
      init: function init(_ref) {
        ...
        var isCurrentInOptions = (0, _some.default)(items, function (item) {
          return Number(state.hitsPerPage) === Number(item.value);
        });

        if (!isCurrentInOptions) {
          (0, _utils.warning)(state.hitsPerPage !== undefined, "\n`hitsPerPage` is not defined.\nThe option `hitsPerPage` needs to be set using the `configure` widget.\n\nLearn more: https://community.algolia.com/instantsearch.js/v2/widgets/configure.html\n            ");
          (0, _utils.warning)(false, "No items in HitsPerPage `items` with `value: hitsPerPage` (hitsPerPage: ".concat(state.hitsPerPage, ")"));
          items = [{
            value: '',
            label: ''
