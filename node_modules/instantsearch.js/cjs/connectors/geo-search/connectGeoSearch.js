...
var connectGeoSearch = function connectGeoSearch(renderFn, unmountFn) {
  ...
  return function () {
    ...
    var init = function init(initArgs) {
      ...
      widgetState.internalToggleRefineOnMapMove = createInternalToggleRefinementOnMapMove(_noop.default, initArgs);
      widgetState.internalSetMapMoveSinceLastRefine = createInternalSetMapMoveSinceLastRefine(_noop.default, initArgs);
      renderFn({
        items: [],
