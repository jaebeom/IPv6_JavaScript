...
function connectRange(renderFn, unmountFn) {
  ...
  return function () {
    ...
    var hasMinBound = (0, _isFinite2.default)(minBound);
    var hasMaxBound = (0, _isFinite2.default)(maxBound);
    ...
    return {
      _getCurrentRange: function _getCurrentRange(stats) {
        ...
        if (hasMinBound) {
          min = minBound;
        } else if ((0, _isFinite2.default)(stats.min)) {
          min = stats.min;
        } else {
          min = 0;
        }
        ...
        if (hasMaxBound) {
          max = maxBound;
        } else if ((0, _isFinite2.default)(stats.max)) {
          max = stats.max;
        } else {
          max = 0;
        }
      ...
      _getCurrentRefinement: function _getCurrentRefinement(helper) {
        ...
        var min = (0, _isFinite2.default)(minValue) ? minValue : -Infinity;
        var max = (0, _isFinite2.default)(maxValue) ? maxValue : Infinity;
        return [min, max];
      },
      _refine: function _refine(helper, currentRange) {
        ...
        return function () {
          ...
          var isValidNewNextMin = (0, _isFinite2.default)(newNextMin);
          var isValidMinCurrentRange = (0, _isFinite2.default)(currentRangeMin);
          ...
          var isValidNewNextMax = (0, _isFinite2.default)(newNextMax);
          var isValidMaxCurrentRange = (0, _isFinite2.default)(currentRangeMax);
      ...
      getConfiguration: function getConfiguration(currentConfiguration) {
        ...
        var isMinBoundValid = (0, _isFinite2.default)(minBound);
        var isMaxBoundValid = (0, _isFinite2.default)(maxBound);
      ...
      render: function render(_ref12) {
        ...
        var facet = (0, _find.default)(facetsFromResults, {
          name: attribute
        });
