...
function connectConfigure() {
  var renderFn = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _noop.default;
  var unmountFn = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _noop.default;
  return function () {
    var widgetParams = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    if (!(0, _isPlainObject.default)(widgetParams.searchParameters)) {
