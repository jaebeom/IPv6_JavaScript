...
function (_EventEmitter) {
  ...
  function InstantSearch(options) {
    ...
    if (routing === true) _this.routing = ROUTING_DEFAULT_OPTIONS;else if ((0, _isPlainObject.default)(routing)) _this.routing = _objectSpread({}, ROUTING_DEFAULT_OPTIONS, routing);
    return _this;
  }
  /**
...
function enhanceConfiguration(configuration, widgetDefinition) {
  ...
  var customizer = function customizer(a, b) {
    ...
    if (Array.isArray(a)) {
      return (0, _union.default)(a, b);
    } // avoid mutating objects


    if ((0, _isPlainObject.default)(a)) {
      return (0, _mergeWith.default)({}, a, b, customizer);
    }

    return undefined;
  };

  return (0, _mergeWith.default)({}, configuration, partialConfiguration, customizer);
}
