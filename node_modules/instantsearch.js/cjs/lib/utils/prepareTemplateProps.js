...
function prepareTemplates() {
  ...
  var allKeys = (0, _uniq.default)([].concat(_toConsumableArray((0, _keys.default)(defaultTemplates)), _toConsumableArray((0, _keys.default)(templates))));
  return (0, _reduce.default)(allKeys, function (config, key) {
