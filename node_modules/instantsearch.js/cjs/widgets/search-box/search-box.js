...
var renderer = function renderer(_ref) {
  ...
  return function (_ref2) {
    ...
    (0, _preactCompat.render)(_preactCompat.default.createElement(_SearchBox.default, {
      query: query,
...
function searchBox() {
  ...
  if (containerNode.tagName === 'INPUT') {
    throw new Error("The `container` option doesn't accept `input` elements since InstantSearch.js 3.\n\nYou may want to migrate using `connectSearchBox`: ".concat((0, _utils.createDocumentationLink)({
      name: 'searchbox',
      connector: true
    }), "."));
  }

  (0, _utils.warning)(typeof autofocus === 'boolean', 'The `autofocus` option only supports boolean values since InstantSearch.js 3.');
  var cssClasses = {
